...
public:
    ...
    QLineEdit *taiere_jos;
    QLineEdit *taiere_sus;
    QLineEdit *alfa;
    QLineEdit *esantion;
    QLineEdit *taps;
    QLineEdit *sample;
...
"background-color: rgb(230, 234, 255);"));
        ...
        taiere_jos = new QLineEdit(layoutWidget);
        taiere_jos->setObjectName(QString::fromUtf8("taiere_jos"));

        verticalLayout_2->addWidget(taiere_jos);

        taiere_sus = new QLineEdit(layoutWidget);
        taiere_sus->setObjectName(QString::fromUtf8("taiere_sus"));

        verticalLayout_2->addWidget(taiere_sus);
        ...
        sample = new QLineEdit(layoutWidget);
        sample->setObjectName(QString::fromUtf8("sample"));

        verticalLayout_2->addWidget(sample);
    ...
    void retranslateUi(QMainWindow *proiectClass)
    {
        ...
        label->setText(QApplication::translate("proiectClass", "Frecventa taiere jos", nullptr));
        label_2->setText(QApplication::translate("proiectClass", "Frecventa taiere sus", nullptr));
        ...
        label_6->setText(QApplication::translate("proiectClass", "Sampling Frequency", nullptr));
        ...
        pushButton->setText(QApplication::translate("proiectClass", "hanning", nullptr));
    } // retranslateUi
